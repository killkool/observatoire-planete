...
import { currentTowardsUv, formatCelsius, formatDaysGe30, formatHpaFromPa, formatKmhFromMs, formatMjFromJm2, formatMmWaterFromM, formatWindFromDeg, roundToPrecision, windFromUv } from "../packages/weather-core/src/units";
...
assert.ok(homeCacheSrc.includes("featured-climate-v3"));
...
assert.ok(climateOgSrc.includes("Jours à 30 °C ou plus"));
...
assert.ok(homeOgSrc.includes("Jours à 30 °C ou plus"));
