...
| ERA5 point Grenoble (1 jour, 2t + d2m + TP + vent + MSL + SP + neige SWE + SSRD + rafale) + quotidien 2t France un jour (JSON) | R9 remainder : archive quotidienne 1940–2026, pas mondial |
