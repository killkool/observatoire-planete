...
**Date de revue :** 2026-09-07 (ERA5 point Grenoble, records 12 mai)  
...
Le parcours **Isère → Météo-France → Grenoble → 1983-05-12 → ERA5 point (2t + rosée + pluie + vent 10 m + MSL + SP + neige SWE + SSRD + rafale) → comparaison sans fusion → provenance → confiance** est livré. Même point **5 jours** (12 mai 1982 et 1986, 11–13 mai 1983 ; 70 lignes SQL). Quotidien 2t bbox France : **3 jours** (2709 mailles JSON, pas SQL). LCP lab **2535 ms** — pas un pass Core Web Vitals.
...
Tests : `npm run test:science`. Pages : `/meteo/auvergne-rhone-alpes/isere/grenoble?date=1983-05-12` · `?date=1983-05-11` · `?date=1983-05-13` · `?date=1982-05-12` (CORENC 5,1 / 26,1 °C, ERA5 2,8 / 18,6 °C) · `?date=1986-05-12` (CORENC 11,6 / 32,1 °C, ERA5 8,6 / 22,2 °C, ΔTmax −9,9 °C) · `?date=1900-01-01` · `/` · `/naissance` · `/comparer?a=38185&b=38563`.
