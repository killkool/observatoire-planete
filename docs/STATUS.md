...
**Date de revue :** 2026-09-07 (cartes OG accueil / naissance / comparer = exemples officiels)  
...
| R11 SEO | **Fait (Isère)** | titres, héros et OG commune sans query = dernière année climatique officielle ; landings OG `/og/accueil` (exemple Grenoble 2025, pas Crolles) `/og/naissance` (1983 CORENC) `/og/comparer` (Voiron, pas `?a=&b=`) ; JSON-LD jour seulement si `?date=` ; titres date/naissance/comparer officiels + sitemap + hreflang + `seo-content-v1` ; pas de pages en |
