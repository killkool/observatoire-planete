...
**Date de revue :** 2026-09-07 (comparer : HTML initial + titres officiels)  
...
| R12 mobile | **Partiel** | 390 px ; HTML initial 56 Ko ; héros = Tmin/Tmax/pluie + station ; comparer SSR ; Lighthouse lab LCP 2178 ms ; pas CDN, pas CrUX |
