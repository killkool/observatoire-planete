...
- `method_version` point : `era5-point-nearest-hourly-2t-d2m-tp-uv10-msl-sp-sd-ssrd-i10fg-v1`. Quotidien France un jour : `era5-france-daily-2t-minmax-v1` (JSON, pas SQL). Version jeu : ERA5 finale (1983).
