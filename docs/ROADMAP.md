...
Dernière mise à jour : 2026-09-07 (records d’année LVD = 2009 · 700,6 mm plus sèche). Tableau : [STATUS.md](./STATUS.md).
...
53. [x] Phase R4/R11/R12 — année climatique canonique : écart min-max annuel (Grenoble 2025 · **11,4 °C**, dérivé des moyennes Tmin/Tmax arrondies, pas une colonne SQL, pas le record 2003/2022 **12,2 °C**, pas 2013 **10,1 °C**, pas 13,8 °C / 2026 incomplet) dans le héros, l’accueil, la description, le partage et les OG
...
62. Ne **pas** extraire ERA5 mondial. Ne **pas** activer océan / NOAA / API commerciale. Ne **pas** feindre Vercel/Supabase. Ne **pas** extraire massivement les tuiles IGN.
...
- [x] records d’année observés (plus chaude / plus froide / plus arrosée / plus sèche / plus de jours ≥ 30 °C / plus de jours de gel / plus de nuits tropicales / plus de jours ≥ 35 °C / plus de jours ≥ 25 °C / plus de jours de pluie / plus grand écart min-max, station + période) ; records jour déjà en R5. Records de **mois** livrés. Épisodes Tmax consécutifs livrés (`heat-streak-tmax-v1`) — **pas** la canicule officielle Météo-France
...
- [x] HTML initial commune / accueil / OG climat = écart min-max annuel de la dernière année complète (Grenoble 2025 · **11,4 °C**, dérivé Tmin/Tmax, pas 2003/2022 **12,2 °C**, pas 2013 **10,1 °C**, pas 13,8 °C / 2026 incomplet)
