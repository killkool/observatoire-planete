...
Dernière mise à jour : 2026-09-07 (année climatique canonique = jours de gel officiels). Tableau : [STATUS.md](./STATUS.md).
...
38. [x] Phase R1/R4/R12 — accueil : cartes Grenoble / Crolles / La Pierre = dernière année climatique officielle (LVD 2025 · max. 19,6 °C · 901,1 mm · **57 j ≥ 30 °C** · **46 j de gel**, 10,2 km, pas le record 2022) ; même poste = mêmes chiffres, pas d’écart inventé ; cache `featured-climate-v5`
...
48. Ne **pas** extraire ERA5 mondial. Ne **pas** activer océan / NOAA / API commerciale. Ne **pas** feindre Vercel/Supabase. Ne **pas** extraire massivement les tuiles IGN.
