...
Dernière mise à jour : 2026-09-07 (année climatique canonique = écart min-max 11,4 °C LVD 2025). Tableau : [STATUS.md](./STATUS.md).
...
54. Ne **pas** extraire ERA5 mondial. Ne **pas** activer océan / NOAA / API commerciale. Ne **pas** feindre Vercel/Supabase. Ne **pas** extraire massivement les tuiles IGN.
