...
| 8 | ERA5 | [ ] *partiel* (point Grenoble 1983-05-12 ; pas France, pas mondial) |
| 9 | ERA5-LAND | [ ] |
| 10 | NOAA GHCN DAILY | [ ] |
| 11 | NOAA ISD | [ ] |
| 12 | NOAA OCÉAN | [ ] |
...
| 103 | PHASE 5 — ERA5 FRANCE | [ ] *partiel* (point Grenoble seulement ; pas de subset France) |
...
| 138 | CACHE | [ ] *partiel* (`unstable_cache` 1 h accueil/sitemap/jour/climat/enfance ; HTML initial = mesure + climat + enfance ; MapLibre/Recharts différés ; pas CDN) |
| 139 | PRECOMPUTATION | [ ] |
