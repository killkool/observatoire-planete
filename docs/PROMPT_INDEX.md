...
| 125 | PAGE MOBILE | [ ] *partiel* (390 px ; HTML page 56 Ko sans mois/saisons/chaleur ; heatmap « ce jour » = liens `?date=` ; Lighthouse lab LCP 2535 ms ; héros WebP hors optimizer 2779 ms revert ; pas de bottom sheet GIS) |
