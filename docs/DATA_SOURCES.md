...
| V1 | Point Grenoble **3 jours** (11–13 mai 1983) ingéré (2t + rosée + TP + vent 10 m + MSL + SP + neige SWE + SSRD + rafale). Quotidien 2t bbox France **3 jours** en JSON (2709 mailles / jour), pas importé en SQL. Pas de grille mondiale, pas 1940–2026. |
