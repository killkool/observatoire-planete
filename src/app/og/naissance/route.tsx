...
import { buildBirthLandingOgModel } from "@/lib/landingOg";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

export async function GET() {
  const card = buildBirthLandingOgModel();
  if (!card) {
    return new Response("Aucun exemple de naissance observé.", { status: 404 });
  }
